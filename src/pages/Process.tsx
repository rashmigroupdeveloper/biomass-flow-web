            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-gray-600">
                  Our facilities utilize energy-efficient technologies and renewable power sources.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  Advanced water recycling systems minimize freshwater usage in our operations.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  All by-products from our manufacturing process are repurposed or recycled.
                </p>
              </motion.div>
            </div>
          </motion.div>

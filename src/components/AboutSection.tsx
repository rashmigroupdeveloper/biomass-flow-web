      ...
      <div className="container mx-auto px-6 md:px-12 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Leading the <span className="text-primary-500 relative inline-block">
                Green Revolution
                <span className="absolute -bottom-1 left-0 w-full h-0.5 bg-primary-500 transform scale-x-0 origin-left group-hover:scale-x-100 transition-transform duration-300"></span>
              </span> in Energy
            </motion.h2>
            ...
            <motion.p 
              variants={itemVariants}
              className="text-gray-600 mb-6 leading-relaxed hover:text-gray-800 transition-colors duration-300"
            >
            ...
            <motion.p 
              variants={itemVariants}
              className="text-gray-600 mb-8 leading-relaxed hover:text-gray-800 transition-colors duration-300"
            >
            ...
            >
              {[
                ...
                <motion.div 
                  ...
                  className="flex flex-col p-4 border border-primary-100 rounded-lg bg-white hover:border-primary-300 transition-all duration-500 hover:bg-gradient-to-br hover:from-white hover:to-primary-50"
                >
                  <span className="text-3xl font-bold text-primary-500 relative group">
                    {stat.value}
                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary-500 group-hover:w-full transition-all duration-500"></span>
                  </span>

...
/**
 * Biomass Particle Animation System
 * 
 * This utility creates an interactive particle animation that represents
...
export class BiomassParticleSystem {
  ...
  private mousePosition: { x: number | null; y: number | null };
  private lastFrameTime: number;
  private isRunning: boolean;
  private animationFrameId: number | null;

  constructor(canvasId: string, options: Record<string, any> = {}) {
    // Canvas setup
   ...
   */
  public updateOptions(newOptions: Record<string, any>) {
  ...
  private _setupEventListeners() {
    ...
    if (this.options.mouseInteraction) {
      ...
      this.canvas.addEventListener('touchmove', this._onMouseMove as any);
  ...
  private _removeEventListeners() {
    ...
    this.canvas.removeEventListener('touchmove', this._onMouseMove as any);
   ...
   * @private
   */
  private _onMouseMove(event: MouseEvent | TouchEvent) {
   ...
   */
  private _createParticle(x?: number, y?: number) {
